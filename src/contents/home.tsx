    ...
    <div className="m-h-[100vh] bg-primary">
      <div className="container mx-auto">
        ...
        <div className="flex py-10 relative min-h-[500px] mb-20">
          ...
          <div className="w-[56%] text-3xl text-[#567357] border-4 border-[#E58688] p-4">As plastic pollution intensifies globally, traditional recycling and chemical degradation methods face high energy consumption, low efficiency, and severe environmental burdens. In green chemistry, enzymatic degradation has emerged as a sustainable alternative. Unlike harsh chemical or thermal treatments, enzyme-catalyzed depolymerization of polyesters such as PET occurs under mild conditions, with high selectivity and minimal by-products. This biological approach transforms non-degradable plastics into reusable monomers, advancing the circular economy of plastics.</div>
        </div>
        <div className="py-4 border-b-4 border-[#E58688]" style={{borderStyle: "dashed"}}>
        ...
        <div className="flex justify-end py-10  min-h-[300px] mb-20 relative">
          ...
          <div className="w-[66%] text-3xl text-[#567357] border-4 border-[#E58688] p-4">Our experiment aims to engineer and screen high-performance PET-hydrolyzing enzyme variants, validate their thermostability, and PET-depolymerizing activity. </div>
        </div>
        <div className="flex py-10 relative min-h-[500px] mb-20">
          <img src="images/home/3.png" className="w-[40%] absolute right-0 bottom-0" />
          <div className="w-[56%] text-3xl text-[#567357] border-4 border-[#E58688] p-4">
        ...
        <div className="flex justify-end py-10  min-h-[300px] mb-20 relative">
          ...
          <div className="w-[66%] text-3xl text-[#567357] border-4 border-[#E58688] p-4">We hope our work advances PET-degrading enzyme development. Though industrial application needs further refinement, we will continue optimizing, aiming to contribute to solving global plastic pollution. </div>
        </div>
      </div>
